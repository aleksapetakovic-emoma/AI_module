...
risk(Age,low,Diseases,_) :- Age<55, countDiseases(Diseases,Y), Y<2,
    						noCriticalDisease(Diseases); 
    					(   age(Age,acceptable), not(mentalHealth(Diseases)),!).

risk(Age,medium,Diseases,_):-  noCriticalDisease(Diseases), (   
                                                            (mentalHealth(Diseases), age(Age,X), X = over55,!); 
                                                            (mentalHealth(Diseases), Age<55, countDiseases(Diseases,2),!);
