...
x_train, x_test, y_train, y_test = train_test_split(train_dataset, train_labels , train_size = 0.75, random_state =  21)
...
model.fit(x_train,y_binary_train, validation_data=(x_test, y_binary_test) ,callbacks = [cp_callback],epochs=2000)
